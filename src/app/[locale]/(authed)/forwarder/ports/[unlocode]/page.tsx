...
export default async function ForwarderEditPortPage({
  params,
}: {
  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-4 py-10 sm:px-6">
      <div className="mb-6">
        <Link href="/forwarder/ports" className="text-sm text-brand-600 underline">
          ← Back to ports
        </Link>
      </div>
      ...
      <PortEditForm port={port} locale={locale} backHref={`/${locale}/forwarder/ports`} />
    </div>
  );
}
